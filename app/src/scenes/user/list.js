                        ...
                        <div>
                          ...
                          <div className="flex justify-between flex-wrap mt-3">
                            ...
                            <div className="relative w-full md:w-[48%] mt-2">
                              ...
                              <div className="flex items-center border border-[#FFFFFF] rounded-[10px]">
                                <input
                                    className="projectsInput text-[14px] font-normal text-[#212325] rounded-l-[10px] w-full"
                                    name="password"
                                ...
                                />
                                <button
                                    className="bg-[#F9FBFD] p-2 rounded-r-[10px] border-l border-[#FFFFFF]"
